...
public class AuteurServiceTest {
	...
	private static AuteurService service = (AuteurService) context.getBean("auteurServiceImpl");
	...
	@Test
	public void findAuteurArticleLePlusCommenteTest() {

		Auteur findAuteurArticleLePlusCommente = service.findAuteurArticleLePlusCommente();
		assertTrue(findAuteurArticleLePlusCommente.equals(auteur2));
		assertFalse(findAuteurArticleLePlusCommente.equals(auteur4));

	}

	@Test
	public void listOrderByNombreArticlesTest() {

		List<Auteur> listOrderByNombreArticles = service.listOrderByNombreArticles();

		 assertTrue(listOrderByNombreArticles.get(0).equals(auteur4));
		 assertTrue(listOrderByNombreArticles.get(1).equals(auteur2));
		assertFalse(listOrderByNombreArticles.get(1).equals(auteur4));
		assertFalse(listOrderByNombreArticles.get(1).equals(auteur1));
